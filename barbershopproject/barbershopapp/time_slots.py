...
from .models import Visit, Employee
...
# Функция для получения списка мастеров, предоставляющих услугу
def get_employees_by_service(service):
    """
    Возвращает список мастеров, предоставляющих указанную услугу.

    :param service: объект Service
    :return: QuerySet объектов Employee
    """
    return Employee.objects.filter(services__id=service.id)
